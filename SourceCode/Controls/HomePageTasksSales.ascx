<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HomePageTasksSales.ascx.cs"
            ...
            <asp:GridView ID="grid_SalesOrder" runat="server" AutoGenerateColumns="False" DataKeyNames="SalesOrderId"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Order No">
                        <ItemTemplate>
                            <a href="JavaScript:newPopup('Sales/SalesOrder.aspx?soid=<%#Eval("SalesOrderId") %>')"
