...
/// <summary>
/// Summary description for ProcReleasePO
/// </summary>
public class ProcReleasePO
{
    Common cs = new Common();
	public ProcReleasePO()
	{
		//
    ...
    public bool UpdateRelese(int id, bool isRelease, string Releaseby)
    {
        try
        {
            string sql = "update Inv_Glb_POHeader set PORelease='" + isRelease + "', POReleaseby='" + Releaseby + "' ,POReleseDate='" + DateTime.Now+"'";
