<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/CMaster.master" AutoEventWireup="true" CodeFile="MasterFixedAsset.aspx.cs" Inherits="Finance_MasterFixedAsset" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnl_Master" runat="server" Height="400px">
            </asp:Panel>
