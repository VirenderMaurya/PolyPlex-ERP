...
public partial class Finance_CostCenter : System.Web.UI.Page
{

    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_CostCenterMaster.xml";
    string tablename = "FA_GLb_CostCenterMaster_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "CostCenterCode";
    string aspxPageModuleID = "112";
    string pageHeading = "Cost Center Master";
