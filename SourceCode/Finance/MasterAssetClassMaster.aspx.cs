...
public partial class Finance_MasterAssetClassMaster : System.Web.UI.Page
{
   
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_AssetClassMaster.xml";
    string tablename = "FA_Glb_AssetClass_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "ClassCode";
    string aspxPageModuleID = "176";
    string pageHeading = "Asset Class Master";
