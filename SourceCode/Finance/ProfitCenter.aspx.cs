...
public partial class Finance_ProfitCenter : System.Web.UI.Page
{
    ...
    static int iFlag = 0;
    string xml = "Finance_Master_ProfitCenter.xml";
    string tablename = "FA_GLb_ProfitCenter_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "ProfitCenterCode";
    string aspxPageModuleID = "26";
    string pageHeading = "Profit Center Master";
