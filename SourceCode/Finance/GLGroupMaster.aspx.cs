...
public partial class Finance_GLGroupMaster : System.Web.UI.Page
{

    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_GLGroupMaster.xml";
    string tablename = "FA_GLb_GLGroup_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "GroupGLCode";
    string aspxPageModuleID = "158";
    string pageHeading = "GL Group Master";
