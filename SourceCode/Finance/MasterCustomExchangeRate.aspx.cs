...
public partial class Finance_MasterCustomExchangeRate : System.Web.UI.Page
{
  
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_CustomExchangeRateMaster.xml";
    string tablename = "FA_Glb_CustomExchangeRate_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "ExchangeRateCode";
    string aspxPageModuleID = "7";
    string pageHeading = "Custom Exchange Rate Master";
