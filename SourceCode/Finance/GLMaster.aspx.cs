...
public partial class Finance_GLMaster : System.Web.UI.Page
{

    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_GLMaster.xml";
    string tablename = "FA_GLb_GLMaster_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "GeneralLedgerCode";
    string aspxPageModuleID = "63";
    string pageHeading = "General Leadger Master";
