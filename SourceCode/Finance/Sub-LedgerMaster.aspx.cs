...
public partial class Finance_Sub_LedgerMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_Sub-Ledger(SL)Master.xml";
    string tablename = "FA_GLb_SLMaster_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "SubsidiaryLedgerCode";
    string aspxPageModuleID = "43";
    string pageHeading = "Subsidiary Ledger Master";
