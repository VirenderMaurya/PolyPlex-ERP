...
public partial class Finance_MasterFixedAsset : System.Web.UI.Page
{
   
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_FixedAssetMaster.xml";
    string tablename = "FA_Glb_FixedAsset_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "AssetNo";
    string aspxPageModuleID = "10";
    string pageHeading = "Fixed Asset Master";
