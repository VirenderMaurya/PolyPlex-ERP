...
public partial class Finance_MasterDepriciationKey : System.Web.UI.Page
{
    
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_DepreciationkeyMaster.xml";
    string tablename = "FA_Glb_Depreciationkey_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "DepreciationKey";
    string aspxPageModuleID = "128";
    string pageHeading = "Depriciation Key Master";
