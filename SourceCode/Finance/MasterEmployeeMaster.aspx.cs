...
public partial class Finance_MasterEmployeeMaster : System.Web.UI.Page
{
      
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Finance_Master_EmployeeMaster.xml";
    string tablename = "FA_Glb_EmployeeMaster_Mst";
    string tablePrimarykey = "Id";
    string tableCode = "EmployeeCode";
    string aspxPageModuleID = "203";
    string pageHeading = "Employee Master";
