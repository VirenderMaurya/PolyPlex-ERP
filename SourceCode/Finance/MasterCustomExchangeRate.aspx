<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/CMaster.master" AutoEventWireup="true" CodeFile="MasterCustomExchangeRate.aspx.cs" Inherits="Finance_MasterCustomExchangeRate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnl_Master" runat="server" Height="220px">
            </asp:Panel>
                            ...
                            <td>
                                <asp:Panel ID="pnl_div" runat="server" Height="220px" Width="605px" ScrollBars="Auto">
                                    ...
                                    <asp:GridView ID="gridMaster" runat="server" AllowPaging="True" OnSelectedIndexChanged="gridMaster_SelectedIndexChanged"
                                        Width="100%" EmptyDataText="No  Result match your search criteria." DataKeyNames="Id"
