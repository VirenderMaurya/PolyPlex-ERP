<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/CMaster.master" AutoEventWireup="true" CodeFile="GLMaster.aspx.cs" Inherits="Finance_GLMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnl_Master" runat="server" Height="300px">
            </asp:Panel>
