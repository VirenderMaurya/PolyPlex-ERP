...
public partial class Procurement_AlterUOMMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "AlternateUOMMster.xml";
    string tablename = "Proc_AlterUOM_Master";
    string tablePrimarykey = "AutoId";
    string tableCode = "AUOMCode";
    string aspxPageModuleID = "18";
    string pageHeading = "Alternate Unit of Measurement Master";
