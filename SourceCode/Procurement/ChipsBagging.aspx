<%@ Page Title="" Language="C#" MasterPageFile="~/Procurement/PolyplexMaster.master" AutoEventWireup="true" CodeFile="ChipsBagging.aspx.cs" Inherits="Procurement_ChipsBagging" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <table width="100%"> <tr style="height:25%"><td></td></tr></table>
  ...
  <table width="100%"> <tr><td width="20%" align="right"> Year :</td><td>
      <asp:TextBox ID="txtYear" runat="server" BackColor="Silver" Width="89px"></asp:TextBox></td>
  <td width="20%" align="right"> Vr. Number :</td><td><asp:TextBox ID="txtVrNumber" BackColor="Silver" runat="server"></asp:TextBox> 
   
  </td>
  <td width="20%" align="right"> Bagging Date :</td><td><asp:TextBox ID="txtBaggingDate" BackColor="Silver" Width="70px"  runat="server"></asp:TextBox></td>
  </tr>
        <tr>
            ...
            <asp:DropDownList ID="ddlMaterialcode" runat="server" Width="90px" 
                ...
                </asp:DropDownList>     <asp:TextBox ID="txtUOM" Width="50px" BackColor="Silver" runat="server"></asp:TextBox><br />
           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlMaterialcode"
            ...
            <td width="15%" align="left" valign="top">
                <asp:DropDownList ID="ddlStorageLocation" runat="server" Width="90px">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlStorageLocation"
        ...
        Chips Bages :
            ...
            <td width="10%" align="left" valign="top">
              <asp:TextBox ID="txtChipsBags" Width="70px"  runat="server"></asp:TextBox>
            <asp:FilteredTextBoxExtender ID="fltr" TargetControlID="txtChipsBags" runat="server"
            ...
            <td width="10%" align="left" valign="top">
               <asp:TextBox ID="txtQuantityBags" Width="50px"  runat="server" 
                    AutoPostBack="True" ontextchanged="txtQuantityBags_TextChanged"></asp:TextBox>
                      <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" TargetControlID="txtQuantityBags" runat="server"
                                        FilterType="Custom, Numbers" ValidChars="."  Enabled="True">
                                    </asp:FilteredTextBoxExtender>
            </td>
        </tr>
 ...
 <tr><td>
          <asp:GridView ID="gvChipsBagging" runat="server" AllowPaging="True" PageSize="5" Width="100%"
                                EmptyDataText="No record found" ShowHeaderWhenEmpty="True"
                                AutoGenerateColumns="False"  DataKeyNames="line" 
                                
               OnSelectedIndexChanged="gvChipsBagging_SelectedIndexChanged"  
               OnPageIndexChanging="gvChipsBagging_PageIndexChanging" CssClass="GridViewStyle" onrowcommand="gvChipsBagging_RowCommand"
                              >
                                <Columns>
                                   
                            <asp:BoundField DataField="Line" HeaderText="Line" />
                            <asp:BoundField DataField="BagNo" HeaderText="BagNo" />
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:GridView ID="gridMaster" runat="server" AllowPaging="True" PageSize="5" Width="100%"
                                ...
                                AutoGenerateColumns="False"  DataKeyNames="VRNumber"
                           ...
                           <%--     <asp:Label ID="lblPETPlant" runat="server" Text='<% #Eval("autoid")%>'></asp:Label>--%>
                            ...
                            <asp:BoundField DataField="VRNumber" HeaderText="Voucher Number" />
                             <asp:BoundField DataField="BaggingDate" HeaderText="Bagging Date" />
