...
public partial class Procurement_IncoTermsMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "IncoTermsMaster.xml";
    string tablename = "Proc_IncoTerms_Master";
    string tablePrimarykey = "autoid";
    string tableCode = "icode";
    string aspxPageModuleID = "38";
    string pageHeading = "Inco Terms Master";
