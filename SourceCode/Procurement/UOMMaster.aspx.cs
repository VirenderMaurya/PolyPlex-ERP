...
public partial class Procurement_UOMMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "UOMMaster.xml";
    string tablename = "Proc_UOM_Master";
    string tablePrimarykey = "AutoId";
    string tableCode = "Code";
    string aspxPageModuleID = "131";
    string pageHeading = "Unit of Measurement Master";
