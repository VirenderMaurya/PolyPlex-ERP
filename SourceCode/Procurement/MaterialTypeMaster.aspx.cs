...
public partial class Procurement_MaterialTypeMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "MaterialTypeMaster.xml";
    string tablename = "Proc_MaterialType_Master";
    string tablePrimarykey = "AutoId";
    string tableCode = "Code";
    string aspxPageModuleID = "12";
    string pageHeading = "Material Type Master";
