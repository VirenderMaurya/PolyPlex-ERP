<%@ Page Title="Chips Quality-PTA Analysis Form" Language="C#" MasterPageFile="~/Production/PolyplexMaster.master" AutoEventWireup="true" CodeFile="PTAAnalysis.aspx.cs" Inherits="Procurement_PTAAnalysis" %>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <asp:ImageButton ID="ImgBtnVendor" runat="server" CausesValidation="False" 
                                ImageUrl="~/images/select.gif" OnClick="ImgBtnVendor_Click" /> <asp:Label ID="Lblvendorname" runat="server"></asp:Label>
                            &nbsp; &nbsp;
                        </td>
                        <td width="15%">
                            &nbsp;
                    ...
                    <caption>
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <asp:TextBox ID="TxtTruckNo" runat="server" Width="80px"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <asp:TextBox ID="TxtBagLotNo" runat="server" Width="80px"></asp:TextBox>
                            ...
                            <td width="15%">
                                <asp:TextBox ID="TxtParticlelSize" runat="server" Width="80px"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="fltrparticlesize" runat="server"
                                    Enabled="True" FilterType="Custom, Numbers" 
                                    TargetControlID="TxtParticlelSize" ValidChars=".">
                                </asp:FilteredTextBoxExtender>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="right" width="15%">
                                Solubility in Ammonia Soln
                            </td>
                            <td width="15%">
                                <asp:TextBox ID="TxtSolubilityinAmmonia" runat="server" Width="80px"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="TxtSolubilityinAmmonia_FilteredTextBoxExtender" 
                                    runat="server" Enabled="True" FilterType="Custom, Numbers" 
                                    TargetControlID="TxtSolubilityinAmmonia" ValidChars=".">
                                </asp:FilteredTextBoxExtender>
                            </td>
                            <td width="10%" align="right">
                                Alph</td>
                            ...
                            <td width="15%">
                                <asp:TextBox ID="TxtAsh" runat="server" Width="80px"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" 
                                    Enabled="True" FilterType="Custom, Numbers" TargetControlID="TxtAsh" 
                                    ValidChars=".">
                                </asp:FilteredTextBoxExtender>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td width="15%" align="right">
                                Acid(Mg of KOH/Gm) No</td>
                            <td width="15%">
                                <asp:TextBox ID="TxtAcid" runat="server" Width="80px"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="TxtAcid_FilteredTextBoxExtender" 
                                    runat="server" Enabled="True" FilterType="Custom, Numbers" 
                                    TargetControlID="TxtAcid" ValidChars=".">
                                </asp:FilteredTextBoxExtender>
                            </td>
                            <td width="10%" align="right">
                                Moisture Wt%</td>
