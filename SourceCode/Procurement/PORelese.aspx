<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EmptyMaster.master" AutoEventWireup="true"
    CodeFile="PORelese.aspx.cs" Inherits="Procurement_PORelese" %>
            ...
            <center>
                <table width="80%" cellpadding="3px">
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="left">
                                <asp:TextBox ID="txtReleasePO" runat="server" CssClass="txtbx" Width="130px"></asp:TextBox></div>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                        ...
                        <td>
                            <div align="left">
                                <asp:CheckBox ID="chkReleasePO" runat="server" /></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
