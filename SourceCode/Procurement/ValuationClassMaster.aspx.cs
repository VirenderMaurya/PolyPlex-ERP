...
public partial class Procurement_ValuationClassMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "ValuationClassMaster.xml";
    string tablename = "Proc_ValuationClass_Master";
    string tablePrimarykey = "AutoId";
    string tableCode = "ValuationType";
    string aspxPageModuleID = "153";
    string pageHeading = "Valuation Class Master";
