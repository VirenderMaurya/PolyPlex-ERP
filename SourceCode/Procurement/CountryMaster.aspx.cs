...
public partial class Procurement_CountryMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "CountryMaster.xml";
    string tablename = "FA_CountryClassmst";
    string tablePrimarykey = "Id";
    string tableCode = "CountryCode";
    string aspxPageModuleID = "15";
    string pageHeading = "Country Master";
