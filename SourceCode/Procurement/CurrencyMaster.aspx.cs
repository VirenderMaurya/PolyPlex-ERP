...
public partial class Procurement_CurrencyMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "CurrencyMaster.xml";
    string tablename = "Com_Currency_Mst";
    string tablePrimarykey = "CurrencyID";
    string tableCode = "CurrencyCode";
    string aspxPageModuleID = "95";
    string pageHeading = "Currency Master";
