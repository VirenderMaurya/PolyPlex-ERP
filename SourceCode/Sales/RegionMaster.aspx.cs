...
public partial class Sales_RegionMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "SalesMaster-Region.xml";
    string tablename = "Proc_RegionMaster";
    string tablePrimarykey = "AutoId";
    string tableCode = "RCode";
    string aspxPageModuleID = "245";
    string pageHeading = "Region Master";
