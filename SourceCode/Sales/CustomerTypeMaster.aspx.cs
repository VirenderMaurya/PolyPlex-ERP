...
public partial class Sales_CustomerTypeMaster : System.Web.UI.Page
{
    ...
    static int iFlag = 0;
    string xml = "CustomerType.xml";
    string tablename = "Com_CustomerTypeMst";
    string tablePrimarykey = "Id";
    string tableCode = "TypeCode";
    string aspxPageModuleID = "248";
    string pageHeading = "Customer Type Master";
