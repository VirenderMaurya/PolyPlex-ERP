...
public partial class Sales_ConsigneeMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "SalesMaster-Consignee.xml";
    string tablename = "Com_ConsigneeTo_Mst";
    string tablePrimarykey = "ConsigneeToID";
    string tableCode = "ConsigneeCode";
    string aspxPageModuleID = "250";
    string pageHeading = "Consignee Master";
