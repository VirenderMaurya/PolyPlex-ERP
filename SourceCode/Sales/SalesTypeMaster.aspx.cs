...
public partial class Sales_SalesTypeMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "SalesMaster-SalesType.xml";
    string tablename = "Com_SalesType_Mst";
    string tablePrimarykey = "SalesTypeId";
    string tableCode = "SalesType";
    string aspxPageModuleID = "247";
    string pageHeading = "Sales Type Master";
