...
public partial class Sales_CustomerTypeMaster : System.Web.UI.Page
{
    ...
    static int iFlag = 0;
    string xml = "SalesArea.xml";
    string tablename = "Com_SalesArea_Mst";
    string tablePrimarykey = "AutoId";
    string tableCode = "SalesAreaCode";
    string aspxPageModuleID = "252";
    string pageHeading = "Sales Area Master";
