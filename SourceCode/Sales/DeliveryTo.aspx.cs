...
public partial class Sales_DeliveryTo : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "SalesMaster-DeliveryTo.xml";
    string tablename = "Com_DeliveryTo_Mst";
    string tablePrimarykey = "DeliveryToID";
    string tableCode = "DeliveryToCode";
    string aspxPageModuleID = "250";
    string pageHeading = "Delivery To Master";
