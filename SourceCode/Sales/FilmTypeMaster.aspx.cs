...
public partial class Sales_CustomerTypeMaster : System.Web.UI.Page
{
    
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "FilmType.xml";
    string tablename = "Com_FilmType_Mst";
    string tablePrimarykey = "FilmTypeID";
    string tableCode = "FilmTypeCode";
    string aspxPageModuleID = "251";
    string pageHeading = "Film Type Master";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        createformAll(int.Parse(hf_code.Value));       
    }
    ...
    void fillSearch()
    {
        ...
        dt = obj.Get_SearchCriteria(aspxPageModuleID);
        
        DropDownList ddlSearch = (DropDownList)Master.FindControl("dd_search");
    ...
    void btn_Search_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            MyMessageBoxInfo.Show(MyMessageBox.MessageType.Info, objMsg.SelectValue, 125, 300);
        }        
    }
    ...
    protected void btn_save_Click(object sender, EventArgs e)
    {
        if (hf_IsNewRecord.Value == "true")
        {
            ...
            masterControlVisible("btn_save");
            masterControlVisible("btn_cancel");
            string codeValue = txt_primary.Text;
            if (obj.RecordExists(tablename, tableCode, codeValue))
            {
