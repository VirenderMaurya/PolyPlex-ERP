<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/CMaster.master" AutoEventWireup="true"
    CodeFile="MasterPaymentTerms.aspx.cs" Inherits="Sales_MasterPaymentTerms" %>
                            ...
                            <td>
                                <asp:Panel ID="pnl_div" runat="server" Height="220px" Width="605px" ScrollBars="Auto">
                                    ...
                                    <asp:GridView ID="gridMaster" runat="server" AllowPaging="True" OnSelectedIndexChanged="gridMaster_SelectedIndexChanged"
                                        Width="100%" EmptyDataText="No  Result match your search criteria." DataKeyNames="PaymentsTermsID"
