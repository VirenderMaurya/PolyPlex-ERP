...
public partial class Sales_MasterFinalDestination : System.Web.UI.Page
{
    ...
    static int iFlag = 0;
    string xml = "Sales MASTER-Final Destination.xml";
    string tablename = "Sal_Glb_FinalDestination_Mst";
    string tablePrimarykey = "FinalDestinationID";
    string tableCode = "FinalDestCode";
    string aspxPageModuleID = "182";
    string pageHeading = "Final Destination Master";
