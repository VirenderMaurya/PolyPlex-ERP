...
public partial class Sales_MasterPaymentTerms : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Sales MASTER-Payment Terms.xml";
    string tablename = "Sal_Glb_PaymentTerms_Mst";
    string tablePrimarykey = "PaymentsTermsID";
    string tableCode = "PaymentTermCode";
    string aspxPageModuleID = "37";
    string pageHeading = "Payment Terms Master";
