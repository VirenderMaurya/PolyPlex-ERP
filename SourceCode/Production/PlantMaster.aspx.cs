...
public partial class Production_PlantMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "PLANTMaster.xml";
    string tablename = "Com_Plant_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "PlantCode";
    string aspxPageModuleID = "215";
    string pageHeading = "Plant Master";
