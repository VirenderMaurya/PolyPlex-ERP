<%@ Page Title="" Language="C#" MasterPageFile="~/Production/Listing/PolyplexMaster.master"
    AutoEventWireup="true" CodeFile="DailyProductionPetMet.aspx.cs" MaintainScrollPositionOnPostback="true"
    ...
    <div style="height: auto; position: relative;">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td align="right">
                    <asp:Label runat="server" Text="Date:" ID="Label1"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDate" runat="server" TabIndex="27" Width="80%"></asp:TextBox>
                    <asp:ImageButton ID="imgBtnDate" ValidationGroup="aa" runat="server" ImageUrl="~/Images/cal.gif" /><asp:CalendarExtender
                        ID="calExtenderCustomerOrderDate" runat="server" TargetControlID="txtDate"
                        PopupButtonID="imgBtnDate" Format="MM/dd/yyyy" Enabled="True">
