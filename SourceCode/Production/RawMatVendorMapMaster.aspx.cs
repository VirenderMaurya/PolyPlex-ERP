...
public partial class Production_RawMatVendorMapMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "RawMaterialVendorMappingMaster.xml";
    string tablename = "Prod_RawMaterial_Vendor_Mapping_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "MappingCode";
    string aspxPageModuleID = "212";
    string pageHeading = "Raw Material-Vendor Mapping Master";
