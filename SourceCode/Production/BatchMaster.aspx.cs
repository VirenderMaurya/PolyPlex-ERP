...
public partial class Production_BatchMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "BatchMaster.xml";
    string tablename = "Prod_Batch_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "BatchCode";
    string aspxPageModuleID = "231";
    string pageHeading = "Batch Master";
