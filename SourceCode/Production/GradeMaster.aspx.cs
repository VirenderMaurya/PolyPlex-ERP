...
public partial class Production_GradeMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "GradeMaster.xml";
    string tablename = "Prod_Grade_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "GradeCode";
    string aspxPageModuleID = "206";
    string pageHeading = "Grade Master";
