...
public partial class Production_ProcessMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "ProcessMaster.xml";
    string tablename = "Prod_Process_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "ProcessCode";
    string aspxPageModuleID = "230";
    string pageHeading = "Process Master";
