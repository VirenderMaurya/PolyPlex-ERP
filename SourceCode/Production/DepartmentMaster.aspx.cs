...
public partial class Production_DepartmentMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "DepartmentMaster.xml";
    string tablename = "Prod_Dept_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "DeptCode";
    string aspxPageModuleID = "53";
    string pageHeading = "Department Master";
