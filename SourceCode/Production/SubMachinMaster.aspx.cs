...
public partial class Production_SubMachinMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "SubMachinMaster.xml";
    string tablename = "Prod_SubMachine_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "SubMachineCode";
    string aspxPageModuleID = "33";
    string pageHeading = "Sub Machine Master";
