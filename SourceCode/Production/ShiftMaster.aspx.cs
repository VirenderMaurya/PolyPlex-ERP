...
public partial class Production_ShiftMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "ShiftMaster.xml";
    string tablename = "Prod_Shift_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "ShiftCode";
    string aspxPageModuleID = "208";
    string pageHeading = "Shift Master";
