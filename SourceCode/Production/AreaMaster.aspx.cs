...
public partial class Production_AreaMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "AreaMaster.xml";
    string tablename = "Prod_Area_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "AreaCode";
    string aspxPageModuleID = "138";
    string pageHeading = "Area Master";
