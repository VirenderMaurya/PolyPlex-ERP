...
public partial class Production_KKMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "KKTYPEMaster.xml";
    string tablename = "Prod_KKType_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "KCode";
    string aspxPageModuleID = "181";
    string pageHeading = "KK Master";
