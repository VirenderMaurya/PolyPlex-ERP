...
public partial class Production_ExtruderMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "EXTRUDERMaster.xml";
    string tablename = "Prod_Extruder_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "ExtruderCode";
    string aspxPageModuleID = "207";
    string pageHeading = "Extruder Master";
