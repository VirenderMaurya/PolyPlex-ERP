...
public partial class Production_StorageLocationMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "StorageLocationMaster.xml";
    string tablename = "Prod_StorageLocation_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "StorageLocCode";
    string aspxPageModuleID = "216";
    string pageHeading = "Storage Location Master";
