...
using System.Data;
public partial class Production_ProjectMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "ProjectMaster.xml";
    string tablename = "Prod_Project_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "ProjectCode";
    string aspxPageModuleID = "211";
    string pageHeading = "Project Master";
