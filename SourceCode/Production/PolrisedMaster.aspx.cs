...
public partial class Production_PolrisedMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "PolarizedMaster.xml";
    string tablename = "Prod_Polrised_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "PolCode";
    string aspxPageModuleID = "213";
    string pageHeading = "Polrised Master";
