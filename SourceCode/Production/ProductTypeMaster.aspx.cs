...
public partial class Production_ProductTypeMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "ProductTypeMaster.xml";
    string tablename = "Prod_ProductType_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "ProductTypeCode";
    string aspxPageModuleID = "232";
    string pageHeading = "Product Type Master";
