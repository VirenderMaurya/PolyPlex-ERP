...
using System.Data;
public partial class Production_LineMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "LINEMaster.xml";
    string tablename = "Prod_Line_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "LineCode";
    string aspxPageModuleID = "210";
    string pageHeading = "Line Master";
