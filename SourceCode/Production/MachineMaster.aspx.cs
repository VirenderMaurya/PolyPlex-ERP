...
public partial class Production_MachineMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "MachineMaster.xml";
    string tablename = "Prod_Machine_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "MachineCode";
    string aspxPageModuleID = "214";
    string pageHeading = "Machine Master";
