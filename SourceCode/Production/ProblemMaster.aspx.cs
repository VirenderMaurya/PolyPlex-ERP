...
public partial class Production_ProblemMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "ProblemMaster.xml";
    string tablename = "Prod_Problem_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "ProblemCode";
    string aspxPageModuleID = "119";
    string pageHeading = "Problem Master";
