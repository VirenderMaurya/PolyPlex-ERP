...
public partial class Production_MetalizerMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "Metalizer.xml";
    string tablename = "Prod_Metalizer_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "MetalizerCode";
    string aspxPageModuleID = "225";
    string pageHeading = "Metalizer Master";
