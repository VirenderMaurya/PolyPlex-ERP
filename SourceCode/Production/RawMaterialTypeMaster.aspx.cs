...
public partial class Production_RawMaterialTypeMaster : System.Web.UI.Page
{
    Common_Message objMsg = new Common_Message();
    MasterFormControl obj = new MasterFormControl();
    static int iFlag = 0;
    string xml = "RawMaterialTypeMaster.xml";
    string tablename = "Prod_RawMaterialType_Mst";
    string tablePrimarykey = "autoid";
    string tableCode = "RMTypeCode";
    string aspxPageModuleID = "209";
    string pageHeading = "Raw Material Type Master";
